<?php
	namespace App\Http\Controllers\Setup\Person;
        use App\Http\Controllers\Setup\Person\mydb;
	...
	class Reniec{
		...
		function downCaptcha($name)
		{
			...
			if($captcha!=false)
			{
				file_put_contents($name, $captcha,FILE_USE_INCLUDE_PATH);
				return true;
			}
			return false;
		}
		...
		{
			$rtn=array();
                        //$rutaimg= "/u01/vhosts/app02.wilder.lamb-dev.upeu/httpdocs/backend/lamb_financial/public/captcha.jpg";
                        //$carpeta = __DIR__ ;
                        
                        //$carpetas= explode("app", $carpeta);
                        
                        
                        
                        
                        $rutaimg= "/u01/vhosts/app02.wilder.lamb-dev.upeu/httpdocs/backend/lamb_financial/public/captcha.jpg";
			$Captcha = $this->getCaptcha($rutaimg);
