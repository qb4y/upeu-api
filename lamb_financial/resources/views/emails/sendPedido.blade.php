...
<body>
    <div id="content">
        ...
        <div > 
        <p>
        Estimado: encargado del area de Desarrollo<br/>
        <!-- Estimado: {{$persona}}<br/> -->
        <br/><br/>
        Ha se le ha solicitado un nuevo pedido de Digeti en el mes Julio del año 2019. Se requiere su pronta atención ingresar al sigiente link
        {{$pedido}}, eeee;
        <!-- Ha recibido en formato pdf su boleta del mes de {{$mes}} del año {{$id_anho}}. Asimismo, puede visualizarla en el siguiente link -->
        <a href="https://lamb.upeu.edu.pe/" title="Lamb Web" target="_blank">Click Aqui</a>
        </p>
        </div>
        <div > 
        <br/>
        ...
        <div id="footer">
                <p>Gestion de Pedidos<br/>Universidad Peruana Unión</p>
        </div>
</div>	
</body>
</html>
