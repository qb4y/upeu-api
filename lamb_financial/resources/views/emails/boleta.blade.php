...
<body>
    <div id="content">
        ...
        Estimado: {{$persona}}<br/>
        <br/><br/>
        Ha recibido en formato pdf su boleta del mes de {{$mes}} del año {{$id_anho}}. Asimismo, puede visualizarla en el portal de trabajdor en el siguiente link
        <a href="https://lamb-talent.upeu.edu.pe/worker-portal/pages/payroll/ticket-payment" title="Lamb Talent" target="_blank">Click Aqui</a>
        </p>
        </div>
        <div>
        <br/>
        ...
        <div id="footer">
                <p>Gerencia del Talento Humano<br/>{{$nom_entidad}}</p>
        </div>
</div>	
</body>
</html>
