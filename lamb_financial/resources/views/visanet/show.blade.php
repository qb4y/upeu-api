...
<div class="col-md-12">
   ...
   <?php
   //$ruta = route('visanet/tokens');
   $ruta = $gruta.'/visanet/tokens';
   ...
   <div class="card" id="PrintArea">
    <div class="card-body">
      <form class="login-form" method="POST" action="{{$ruta}}" id="frmpagosvisa" target="frameVisa">
          ...
          <div class="row form-group">
            <label class="control-label col-md-2">*urlexpira</label>
            <div class="col-md-10">
              <input class="form-control form-control-sm" type="text" name="urlexpira"  value="{{$gruta.'/visanet/expirado'}}" aria-describedby="helpper">
            </div>
          </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <iframe name="frameVisa"  width="100%" height="600"></iframe>
                    </div>
