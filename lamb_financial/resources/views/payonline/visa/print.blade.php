    ...
    <div class="card" id="PrintArea">
        <div class="card-body">
            ...
            <div class="span5" style="font-size: 12px;">
                <div  style="margin: 0px 10px 0px 0; display:block;margin:0 auto;  clear: both; margin-top: 5px; width: 100%; text-align: center;"><img src="{{secure_asset('img/logos.png')}}" class="img-rounded" /></div>
