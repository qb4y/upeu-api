...
<div class="col-md-12">
   ...
   <div class="card" id="PrintArea">
    <div class="card-body">
      <form class="login-form" method="POST" action="{{route('visa/tokens')}}" target="frameVisa">
          {{ csrf_field() }}
          ...
          <div class="form-group btn-container text-center">
            ...
            <button type="submit" class="btn btn-primary"><i class="fa fa-sign-in fa-lg fa-fw"></i>Crear Boton Visa</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modalcontrollabel">
                             Pagos Visa
                        </h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <iframe name="frameVisa"  width="500" height="290"></iframe>
                    </div>
                </div>
            </div>
        </div>
